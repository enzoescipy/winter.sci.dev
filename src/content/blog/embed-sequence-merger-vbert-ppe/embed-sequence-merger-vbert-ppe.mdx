...
import malgeumImage from "./source/malgeum.jpg";
import sarangImage from "./source/sarang.jpg";
...
## 임베딩의 임베더, 사서를 돕는 마법 고양이 : Sarang(사랑) and Malgeum(맑음)
<div class="rows">
  <CustomLinkPreview 
    image={sarangImage}
...
의미의 수 뭉치, 디코더가 내보낸 책들을 다시 뭉치는 기술, 그것이 제가 만든 인공지능 - ***사랑과 맑음*** 입니다. **BERT** 가 그랬듯, **vBERT**인 **사랑과 맑음**도 직접 말을 할 수는 없습니다. 말하지 못하는 조용한 사서인 **BERT** 가 만든 책을, 다시 한번 정리하고 묶어 총류로 만드는, 그런 *영리하고 묵묵한 고양이들입니다.*

## 해부학 실험실: vBERT를 직접 체험해보세요

vBERT의 마법 같은 '시간의 연금술'을 직접 느껴보고 싶으신가요? 제가 특별히 설계한 '해부학 실험실(Anatomy Lab)'에서, 임베딩 시퀀스 합성과 제 AI vs 다른 AI와의 경합을 실시간으로 탐험할 수 있습니다. 문장들이 어떻게 하나의 의미 흐름으로 녹아드는지, 여러분의 손으로 확인하세요! 이 도구를 통해 vBERT가 긴 맥락을 어떻게 '기억'하고 보존하는지, 체험하며 이해할 수 있을 거예요.
<div class="rows">

  <CustomLinkPreview 
    url="https://huggingface.co/spaces/enzoescipy/finesse-benchmark-space"
    caption="vBERT `맑음` 체험하러 가기"
    imageAlt="vBERT `맑음` 체험하러 가기"
  />
</div>

링크에 들어가신 뒤, 상단의 `해부학 실험실` 에 들어가주시면 직접 체험이 가능합니다. `연구소` 는 제 모델과 다른 모델(AI) 들 간의 성능 경합(!!) 을 보실 수 있게 준비하였습니다.

## 멈추지 않는 연구 : 개인 AI/ML 연구자로서의 자취를 남기다
...
[직접 논문을 쓰고](https://zenodo.org/records/17641563), 개인 AI/ML 연구자로서 [열심히 연구에 임하는 중입니다](https://orcid.org/0009-0004-3131-5993). 아직은 부족하지만, 더 열심히 연구에 정진해 보겠습니다.

*(혹시 기술적 디테일에 관심이 있으신 분은, [제가 혼신을 다해 올린 영문 아티클](https://www.winter-sci-dev.com/posts/embed-sequence-merger-vbert-ppe-article/) 을 보시면 좋을 것 같습니다.)*
